...
parser.add_argument('-opt', type=str, required=False,
                    help='Path to options YMAL file.', default="/content/EPCE-HDR/codes/options/test/test_sys.yml")
...
for test_loader in test_loaders:
    ...
    util.mkdir(osp.join(dataset_dir, "input"))
    ...
    for data in test_loader:
        ...
        #img_label = img_path[-21:-16] #gamma
        ...
        image_path, alignratio_path = util.generate_paths_withlabel(
            dataset_dir, str(img_label), img_name)
